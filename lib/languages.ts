...
export const swedishLng = {
  ...
  billing: {
    ...
    cancelSubscriptionNoCharge: 'Du kommer inte att debiteras för den här prenumerationen.',
    ...
    checkout: {
      ...
      emailForm: {
        subtitle: 'Innan du kan slutföra ditt köp måste du lägga till en e-postadress dit kvitton skickas.',
      ...
      totalDueAfterTrial: 'Totalt att betala efter att provperioden slutar om {{days}} dagar',
    },
    credit: 'Kredit',
    ...
    pricingTable: {
      ...
      seatCost: {
        ...
        additionalSeats: '({{additionalTierFeePerBlockAmount}}/{{periodAbbreviation}} för ytterligare)',
        unlimitedSeats: 'Obegränsat antal platser',
        tooltip: {
          freeForUpToSeats: 'Gratis för upp till {{endsAfterBlock}} platser.',
          additionalSeatsEach: 'Ytterligare platser kostar {{feePerBlockAmount}}/{{period}} styck.',
          firstSeatsIncludedInPlan: 'De första {{endsAfterBlock}} platserna ingår i planen.',
        },
      },
    },
    ...
    switchToMonthlyWithPrice: 'Byt till månadsvis {{currency}}{{price}} / månad',
